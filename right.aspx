<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="right.aspx.cs" Inherits="right"  StylesheetTheme="right"%>
     ...
     <h3><asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></h3>
        <div id="wenzi22">
           <asp:Repeater ID="Repeater2" runat="server">
               <ItemTemplate >
                   <li><a href="xiangxi.aspx?cl1_id=<%#Eval("cl1_id") %>&id=<%#Eval ("id")%>"><%#Eval("title")%></a><span><%#Eval("datatime", "{0:yyyy-MM-dd}")%></span></li>
                </ItemTemplate>
            </asp:Repeater> 
         </div>  
